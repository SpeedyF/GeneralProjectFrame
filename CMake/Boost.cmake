...
include(${CMAKE_CURRENT_SOURCE_DIR}/CMake/FunctionGetMSVCVersion.cmake)
...
string(REPLACE "^^" ";" PROJ_USE_Boost_LIBRARIES "${PROJ_USE_Boost_LIBRARIES}")

set(proj Boost)
set(proj_DEPENDENCIES )
set(Boost_DEPENDS ${proj})

if(NOT DEFINED BOOST_ROOT AND NOT PROJ_USE_SYSTEM_Boost)
  ...
  if(PROJ_USE_Boost_LIBRARIES)
    string(REPLACE ";" "," _boost_libs "${PROJ_USE_Boost_LIBRARIES}")
    foreach(_boost_lib ${PROJ_USE_Boost_LIBRARIES})
  ...
  if(WIN32)
    ...
    configure_file(${CMAKE_CURRENT_SOURCE_DIR}/CMake/MoveBoostLibsToLibDirForWindows.cmake.in ${WIN32_CMAKE_SCRIPT} @ONLY)
  ...
  if(APPLE)
    ...
    configure_file(${CMAKE_CURRENT_SOURCE_DIR}/CMake/ChangeBoostLibsInstallNameForMac.cmake.in ${APPLE_CMAKE_SCRIPT} @ONLY)
  ...
  set(_boost_cxxflags )
  if(CMAKE_CXX_FLAGS OR PROJ_CXX11_FLAG)
    set(_boost_cxxflags "cxxflags=${PROJ_CXX11_FLAG} ${CMAKE_CXX_FLAGS}")
  endif()
  ...
  ExternalProject_Add(${proj}-download
      URL ${MYPROJ_THIRDPARTY_DOWNLOAD_PREFIX_URL}/boost_${_boost_version}_0.7z
  ...
  # Manual install commands (for a PROJ super-build install)
