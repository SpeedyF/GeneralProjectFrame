  ...
  if(package_depends)
    ...
    foreach(_package ${${_package_visibility}_PACKAGE_NAMES})
      ...
      foreach(dir ${MODULES_PACKAGE_DEPENDS_DIRS})
        if((NOT DEFINED MITK_USE_${_package} OR MITK_USE_${_package}) AND EXISTS "${dir}/PROJ_${_package}_Config.cmake")
          _include_package_config("${dir}/PROJ_${_package}_Config.cmake")
