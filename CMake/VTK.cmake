...
if(NOT DEFINED VTK_DIR)
  ...
  option(PROJ_VTK_DEBUG_LEAKS OFF)
  mark_as_advanced(PROJ_VTK_DEBUG_LEAKS)
  list(APPEND additional_cmake_args
       -DVTK_DEBUG_LEAKS:BOOL=${PROJ_VTK_DEBUG_LEAKS}
      )

  if(PROJ_USE_Python)
    if(NOT PROJ_USE_SYSTEM_PYTHON)
     list(APPEND proj_DEPENDENCIES Python)
     set(_vtk_install_python_dir -DVTK_INSTALL_PYTHON_MODULE_DIR:FILEPATH=${PROJ_PYTHON_SITE_DIR})
    else()
  ...
  set(VTK_URL ${MYPROJ_THIRDPARTY_DOWNLOAD_PREFIX_URL}/VTK-7.0.0.tar.gz)
